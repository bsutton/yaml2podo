...
class ObjectWithMap {
  ...
  factory ObjectWithMap.fromJson(Map map) {
    ...
    result.products = _jc.toMap(map['products'],
        (e) => _jc.toObject(e, (e) => Product.fromJson(e as Map)));
    return result;
  }
...
<pre>
{amount: 32.0, date: 2019-06-02T17:54:15.209994, items: [{qty: 1, price: 10.0, product: {name: Product 0, id: 0}}, {qty: 2, price: 11.0, product: {name: Product 1, id: 1}}]}
